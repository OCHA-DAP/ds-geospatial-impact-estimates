...
14. **LIST provenance/modality**: provider-stated **SAR** (ADR-0020), but the exact basis
    ...
    vision model" while Results III and deck slide 12 type MS∧UH as optical×radar; one of
    those is wrong, and which one changes the cross-modal framing. Needs provider
    confirmation (user decision pending).
