...
- **QUEUED (user hypothesis):** does the day-zero baseline BEAT the products in the
  as-delivered frame? Mechanism for: products blanket-flag low-damage AOIs; day-zero's
  coast-distance term wouldn't. Mechanism against: Caracas has high density + high MMI
  (two of three day-zero inputs vote "flag"). Needs an RQ8 variant over the all-AOI
  frame — not yet computed, do NOT assert either way.
