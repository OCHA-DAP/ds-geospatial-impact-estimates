...
14. **LIST provenance/modality**: provider-stated **SAR** (ADR-0020), but the exact basis
    ...
    those was wrong. RESOLVED BY USER DECISION 2026-08-06: **assume UH is optical** (H1
    retyped accordingly — see the dated entry); provider confirmation of both UH's and
    LIST's imagery still belongs in the provider-dates email.
