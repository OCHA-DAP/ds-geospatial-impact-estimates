...
Run: uv run --with pandas --with matplotlib python \
       exploratory/paper/pipeline/figs/rq8_best_f1_fig.py [radius]
...
df = pd.read_csv(os.path.join(HERE, "..", "..", "frozen", f"rq8_best_f1{SUF}.csv"))
if SUMMARY:
    ...
    asd = pd.read_csv(os.path.join(HERE, "..", "..", "frozen", f"rq8b_asdelivered_baseline{SUF}.csv"))
