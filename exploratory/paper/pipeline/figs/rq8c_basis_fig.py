...
Run: uv run --with pandas --with matplotlib python \
       exploratory/paper/pipeline/figs/rq8c_basis_fig.py
"""
...
gb = pd.read_csv(os.path.join(HERE, "..", "..", "frozen", "rq8c_basis_pr_r10.csv"))
...
print("wrote figures/rq8c_basis_precision_r10.png")
...
print("wrote figures/rq8c_basis_prf1_r10.png")
