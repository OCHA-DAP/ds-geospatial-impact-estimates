...
Run: uv run --group etl --with statsmodels python \
       exploratory/paper/pipeline/figs/rq3_error_structure.py
"""
...
def main():
    ...
    csv = os.path.join(os.path.dirname(__file__), "..", "legacy", "rq3_error_structure_summary.csv")  # diagnostic side output, not a brief input
    ...
    print("wrote figures/rq3_residual_maps_res8.png")
