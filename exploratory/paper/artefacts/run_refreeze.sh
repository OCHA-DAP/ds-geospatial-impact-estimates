...
run rq2s            RQ2-cems-footprint-points/scripts/rq2s_flag_totals.py
...
for s in rq3b_per_area_moran rq3d_lisa_reliability rq3e_reference_free rq3f_null_ranking; do
  run $s RQ3-prioritization-error-structure/scripts/$s.py
done
GIE_SCOPE=core        run rq3f_core        RQ3-prioritization-error-structure/scripts/rq3f_null_ranking.py
GIE_SCOPE=caraballeda run rq3f_caraballeda RQ3-prioritization-error-structure/scripts/rq3f_null_ranking.py
run rq3g_frac_ranking      RQ3-prioritization-error-structure/scripts/rq3g_frac_ranking.py
run rq3h_agreement_ranking RQ3-prioritization-error-structure/scripts/rq3h_agreement_ranking.py
# rq8d anchors on rq3f's core null; run it after the RQ3 batch
run rq8d            RQ8-learned-fusion/scripts/rq8d_null_ablation.py --with-soil
