...
| common | gold | Common-model damage facts (Overture base, coverage-aware) | ds-geospatial-impact-estimates/gold/model=common/adm0=VE/facts.parquet | 10,380 rows; exposed/analysed/coverage/detected/extrapolated per source | ingested | 2026-06-26 |
...
| copernicus_ems | silver | CEMS analysed extent (AOI - not-analysed) | ds-geospatial-impact-estimates/silver/source=copernicus_ems/adm0=VE/analysed_extent.parquet | 12 polygons; coverage mask for detected vs extrapolated | ingesting | 2026-06-26 |
...
| overture | silver | Overture buildings exposure base (event extents) | ds-geospatial-impact-estimates/silver/source=overture/adm0=VE | ~208,971 buildings this run; release 2026-06-17.0; partitioned by region | ingested | 2026-06-26 |
